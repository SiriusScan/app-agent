...
1. Read the [Implementation Plan](PLAN.agent-template-system-implementation.md)
2. Review [Brainstorming Notes](BRAINSTORM.template-system-notes.md) for design rationale
