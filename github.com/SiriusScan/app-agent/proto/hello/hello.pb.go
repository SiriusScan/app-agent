...
const file_proto_hello_hello_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x06 \x01(\x03R\ttimestamp\"M\n" +
...
var file_proto_hello_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_hello_hello_proto_goTypes = []any{
	...
	(*TemplateUpdate)(nil),      // 10: hello.TemplateUpdate
	(*TemplateSyncRequest)(nil), // 11: hello.TemplateSyncRequest
}
var file_proto_hello_hello_proto_depIdxs = []int32{
	...
	11, // 3: hello.AgentMessage.sync_request:type_name -> hello.TemplateSyncRequest
	...
	10, // 7: hello.ServerMessage.template_update:type_name -> hello.TemplateUpdate
	1,  // 8: hello.HelloService.Ping:input_type -> hello.PingRequest
	3,  // 9: hello.HelloService.ExecuteCommand:input_type -> hello.CommandRequest
	5,  // 10: hello.HelloService.ConnectStream:input_type -> hello.AgentMessage
	2,  // 11: hello.HelloService.Ping:output_type -> hello.PingResponse
	4,  // 12: hello.HelloService.ExecuteCommand:output_type -> hello.CommandResponse
	6,  // 13: hello.HelloService.ConnectStream:output_type -> hello.ServerMessage
